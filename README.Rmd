...
These results will be published on the article named *Equidistributed search+Probabilitybased tracking strategy to locate an air pollutant source with two UAVs* ([IEEE Access](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9493205).
